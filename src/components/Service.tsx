      ...
      <ul className=" max-w-6xl m-auto gap-4 mt-8 text-gray-100 grid grid-cols-3  2xl:max-w-6xl">
        {Object.entries(servicesData).map(
          ([key, { icon, title, description }]) => {
            return (
              <li className="border-[3px] even:border-purple-700 w-[341px] h-[322px] place-self-center flex justify-center text rounded-2xl hover:bg-purple-700 transition-colors">
